...
<div class="container py-5">
    ...
    <div class="mb-5">
        ...
        <?php if($category): ?>
        <p class="lead">Showing gifts in: <span class="badge bg-primary"><?php echo e($category); ?></span></p>
        <?php endif; ?>
    </div>
    ...
    <div class="row mb-5">
        <div class="col-md-8">
            ...
            <form action="/products" method="GET" class="row g-3" id="filterForm">
                <input type="hidden" name="search" id="searchInput" value="<?php echo e(request('search')); ?>">
                ...
                <div class="col-md-6">
                    <select name="category" id="categoryFilter" class="form-select" onchange="document.getElementById('filterForm').submit();">
                        ...
                        <option value="<?php echo e($cat->name); ?>" <?php echo e($category == $cat->name ? 'selected' : ''); ?>>
                            <?php echo e($cat->name); ?>
            ...
            <form action="/products" method="GET" class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <select name="sort_by" id="sort_by" class="form-select" onchange="this.form.submit()">
                        <option value="latest" <?php echo e(($sortBy ?? 'latest') == 'latest' ? 'selected' : ''); ?>>Latest</option>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-lg-3 mb-4">
            <div class="card h-100 product-card">
                ...
                <img src="<?php echo e($product->image_url); ?>" class="card-img-top" 
                     alt="<?php echo e($product->name); ?>" style="height: 200px; object-fit: cover;"
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <span class="text-danger h5">$<?php echo e(number_format($product->discount_price, 2)); ?></span>
                            <span class="text-muted text-decoration-line-through small">
                                $<?php echo e(number_format($product->price, 2)); ?>

                            </span>
                            <?php else: ?>
                            <span class="h5">$<?php echo e(number_format($product->price, 2)); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                  ...
                  <div class="d-flex gap-2 mt-3">
                     <a href="/product/<?php echo e($product->id); ?>" class="btn btn-outline-secondary btn-sm flex-grow-1">
                          View Details
                     </a>
      <?php if($product->in_stock): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\blissbox_backup1\blissbox_backup\resources\views/pages/products.blade.php ENDPATH**/ ?>