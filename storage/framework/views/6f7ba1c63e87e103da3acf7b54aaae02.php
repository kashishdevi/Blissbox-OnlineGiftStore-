                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0"><?php echo e($categories->count()); ?></h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0"><?php echo e($categories->where('is_active', true)->count()); ?></h2>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="mb-0">
                                <?php if($categories->count() > 0): ?>
                                    <?php echo e(round(\App\Models\Product::count() / $categories->count(), 1)); ?>
...
document.getElementById('categorySearch').addEventListener('input', function(e) {
    ...
    fetch(`<?php echo e(route('admin.categories.search')); ?>?search=${encodeURIComponent(searchTerm)}`, {
        headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\blissbox_backup1\blissbox_backup\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>