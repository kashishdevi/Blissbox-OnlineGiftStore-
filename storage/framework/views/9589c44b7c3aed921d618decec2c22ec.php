...
<footer class="bg-dark text-white mt-5">
    <div class="container py-5">
        ...
        <div class="row">
            <div class="col-md-6">
                <p class="mb-0">
                    &copy; <?php echo e(date('Y')); ?> BlissBox. All rights reserved.
                </p>
            </div>
...
</footer><?php /**PATH C:\xampp\htdocs\blissbox_backup1\blissbox_backup\resources\views/partials/footer.blade.php ENDPATH**/ ?>