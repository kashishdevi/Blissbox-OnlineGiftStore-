...
<head>
    ...
    <title><?php echo e($product->name); ?> - BlissBox</title>
...
<body>
    ...
    <div class="container" style="margin-top: 80px; padding-top: 20px;">
        ...
        <div class="row g-4">
            ...
            <!-- Product Details -->
            <div class="col-md-6">
                <h1 class="fw-bold mb-3" style="color: var(--dark-color);"><?php echo e($product->name); ?></h1>
                ...
                <div class="mb-4">
                    <?php if($product->discount_price && $product->discount_price < $product->price): ?>
                        <div class="price">$<?php echo e(number_format($product->discount_price, 2)); ?></div>
                        <div class="old-price">$<?php echo e(number_format($product->price, 2)); ?></div>
                        <span class="badge bg-success">Save $<?php echo e(number_format($product->price - $product->discount_price, 2)); ?></span>
                    <?php else: ?>
                    ...
                    <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-3">
                            <div class="card h-100">
                                <a href="/product/<?php echo e($related->id); ?>" class="text-decoration-none">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        <div class="d-flex gap-2">
                                            ...
                                            <form action="<?php echo e(route('cart.add', $related->id)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="quantity" value="1">
                                                <button type="submit" class="btn btn-sm btn-outline-primary" 
                                                        <?php if(!$related->in_stock): ?> disabled <?php endif; ?>>
    ...
    <footer class="py-4 mt-5">
        <div class="container text-center">
            <p class="mb-0" style="color: #cbd5e1;">&copy; <?php echo e(date('Y')); ?> BlissBox. All rights reserved.</p>
        </div>
    </footer>
...
</html><?php /**PATH C:\xampp\htdocs\blissbox_backup1\blissbox_backup\resources\views/pages/product-show.blade.php ENDPATH**/ ?>