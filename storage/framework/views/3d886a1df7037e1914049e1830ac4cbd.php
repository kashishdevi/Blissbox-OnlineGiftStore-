        ...
        <div class="content-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Welcome back, <?php echo e(Auth::user()->name ?? 'Admin'); ?>!</p>
                </div>
                <div class="text-muted">
                    <i class="fas fa-clock me-1"></i><?php echo e(now()->format('F d, Y h:i A')); ?>
        ...
        <div class="content-body">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-xl-3 col-md-6">
                    <a href="<?php echo e(route('admin.orders.index')); ?>" class="overview-card card-link">
                ...
                <!-- Pending Orders Card -->
                <div class="col-xl-3 col-md-6">
                    <a href="<?php echo e(route('admin.orders.index', ['status' => 'pending'])); ?>" class="overview-card card-link">
                        <div class="card border-0 shadow-sm h-100 overview-card-hover">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                ...
                <!-- Total Products Card -->
                <div class="col-xl-3 col-md-6">
                    <a href="<?php echo e(route('admin.products.index')); ?>" class="overview-card card-link">
                        <div class="card border-0 shadow-sm h-100 overview-card-hover">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                ...
                <!-- Total Revenue Card -->
                <div class="col-xl-3 col-md-6">
                    <a href="<?php echo e(route('admin.revenue')); ?>" class="overview-card card-link">
                        <div class="card border-0 shadow-sm h-100 overview-card-hover">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
