...
class Product extends Model
{
    ...
    protected $fillable = [
        ...
        'image', 'images', 'category', 'category_id', 'features', 'in_stock', 
    ...
    {
        if ($this->image) {
            // If it's already a full URL (like from Unsplash or external URL)
            ...
            if (!str_starts_with($imagePath, 'storage/') && !str_starts_with($imagePath, '/')) {
    ...
    // Accessor to get category name (supports both relationship and legacy string field)
