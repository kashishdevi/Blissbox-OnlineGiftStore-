...
@section('title', 'Checkout - BlissBox')
                            ...
                            <form action="{{ route('order.store') }}" method="POST" id="checkoutForm">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" id="notes" name="notes" 
                                              rows="2" placeholder="Special instructions for delivery...">{{ old('notes') }}</textarea>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                                        ...
                                        <small class="text-dark">${{ number_format($item['total'], 2) }}</small>
                                    </div>
                                    @endforeach
                                    ...
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span class="text-dark">${{ number_format($shipping, 2) }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-3">
                                        <span class="text-dark">Tax (8%)</span>
                                        <span class="text-dark">${{ number_format($tax, 2) }}</span>
                                    </div>
                                    <hr>
                                    <div class="d-flex justify-content-between mb-3">
                                        <h5 class="mb-0 text-dark">Total</h5>
                                        <h5 class="mb-0 text-success">${{ number_format($subtotal + $shipping + $tax, 2) }}</h5>
                                    </div>
                                </div>
