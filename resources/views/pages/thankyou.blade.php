...
@section('title', 'Thank You - BlissBox')
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-body text-center p-5">
                    ...
                    <div class="order-details bg-light p-4 rounded mb-4">
                        ...
                        <div class="row text-start">
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="text-primary fw-bold">{{ $order->order_number }}</div>
                            </div>
                            <div class="col-md-6 mb-2">
                            ...
                            <div class="col-12 mt-2">
                                ...
                                <div class="h4 text-success">${{ number_format($order->total, 2) }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                        <a href="{{ route('order.show', $order->id) }}" class="btn btn-primary px-4">
