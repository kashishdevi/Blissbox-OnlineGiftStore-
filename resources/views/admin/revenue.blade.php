...
@section('title', 'Revenue Report - BlissBox Admin')
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <h2 class="mb-0 fw-bold text-success">${{ number_format($totalRevenue, 2) }}</h2>
                ...
                <div class="col-md-4">
                    <div class="card border-0 shadow-sm">
                        <div class="card-body">
                            ...
                            <h2 class="mb-0 fw-bold text-info">${{ number_format($monthlyRevenue, 2) }}</h2>
