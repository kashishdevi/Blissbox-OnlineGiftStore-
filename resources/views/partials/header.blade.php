...
{{-- ONLY the navigation bar, nothing else! --}}
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="dropdown-item" href="{{ route('products', ['category' => 'For Her']) }}">
                                <i class="fas fa-female me-2" style="color: #ec4899;"></i> For Her
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('products', ['category' => 'For Him']) }}">
                                <i class="fas fa-male me-2" style="color: #8b5cf6;"></i> For Him
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('products', ['category' => 'Birthday']) }}">
                                <i class="fas fa-birthday-cake me-2" style="color: #fbbf24;"></i> Birthday
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="{{ route('products', ['category' => 'Anniversary']) }}">
            ...
            <div class="d-flex align-items-center">
                ...
                <!-- Cart -->
                <a href="{{ route('cart') }}" class="btn position-relative me-3 cart-btn" 
                ...
                <!-- Admin Link -->
                <a href="{{ url('/admin') }}" class="btn" style="background: linear-gradient(135deg, #fbbf24, #ec4899); color: #1f2937; border: none; font-weight: 600; padding: 10px 20px; border-radius: 12px;">
...
<div class="d-block d-lg-none container mt-2">
    <form action="{{ route('products') }}" method="GET" class="d-flex">
        <input type="text" name="search" class="form-control" 
               placeholder="Search gifts..." value="{{ request('search') }}"
